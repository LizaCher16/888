...
func TestSetAddress(t *testing.T) {
	...
	require.NoError(t, err)
	// check
	checkNewAddress, err := store.Get(id)
	require.NoError(t, err)
	require.Equal(t, newAddress, checkNewAddress.Address)
...
func TestSetStatus(t *testing.T) {
	...
	require.NoError(t, err)
	// check
	checkNewStatus, err := store.Get(id)
	require.NoError(t, err)
	require.Equal(t, newStatus, checkNewStatus.Status)
